...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Май 15 2022 г., 23:01
...
('Выполнить тестовое задание', 'Выполнить тестовое задание по ТЗ', '2022-05-13', '2022-05-14', '2022-05-15', 1, 1, 1, 2, 1),
('Сделать отчёт', 'Сделать отчёт по \"___\"', '2022-05-13', '2022-05-16', '2022-05-15', 2, 3, 1, 2, 2),
('Сделать техническое задание', 'Сделать ТЗ для работы по ...', '2022-05-15', '2022-05-17', NULL, 1, 1, 1, 2, 3),
('Потушить пожары', 'Потужить пожары в тюменской области', '2022-05-15', '2022-05-18', NULL, 1, 1, 1, 3, 4);
...
('Василий', 'Руководительный', 'Васильевич', 'vasily', '5f4dcc3b5aa765d61d8327deb882cf99', NULL, 1, 'b86b8e0a90'),
('Василий', 'Тестовый', 'Васильевич', 'vasilyTwo', 'db6ff481a8c3b53f90f141c13e4a350c', 1, 2, '4286fc3ba4'),
('Василий', 'Подчинительный', 'Васильевич', 'loginThree', 'passwordThree', 1, 3, NULL);
